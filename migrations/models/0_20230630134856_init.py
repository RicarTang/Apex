...
CREATE TABLE IF NOT EXISTS `permission` (
    ...
    `update_at` DATETIME(6) NOT NULL  COMMENT '更新时间' DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
    `id` INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
    `name` VARCHAR(20) NOT NULL UNIQUE COMMENT '权限名称',
    `description` VARCHAR(50)   COMMENT '权限解释',
...
CREATE TABLE IF NOT EXISTS `role` (
    ...
    `description` VARCHAR(50)   COMMENT '角色详情'
...
CREATE TABLE IF NOT EXISTS `users` (
    ...
    `disabled` SMALLINT NOT NULL  COMMENT '用户活动状态,0:enabled,1:disabled' DEFAULT 0
